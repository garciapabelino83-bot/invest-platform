...
function synthesizeNarration(text, outAudioPath) {
  return new Promise((resolve, reject) => {
    // Importante: "--rate" y su valor van pegados con "=" (ej "--rate=-8%")
    // en un solo argumento. Si van separados, edge-tts (que usa argparse de
    // Python) confunde un valor negativo como "-8%" con otra opcion y falla
    // con "argument --rate: expected one argument".
